        ...
        <div class="top-links">
            <div class="container">
                <ul class="row links">
                    ...
                    <li class="col-xs-12 col-sm-4 link-item"><span>1</span><a href="restaurants.php">Pilih Kategori</a>
                    </li>
                    <li class="col-xs-12 col-sm-4 link-item active"><span>2</span><a
                            href="dishes.php?res_id=<?php echo $_GET['res_id']; ?>">Pilih menu favoritmu</a></li>
                    <li class="col-xs-12 col-sm-4 link-item"><span>3</span><a href="#">Pesan dan Pembayaran</a></li>
                        ...
                        <div class="order-row bg-white">
                            <div class="widget-body">
                                ...
                                <div class="form-group row no-gutter">
                                    <div class="col-xs-8">
                                        <input type="text" class="form-control b-r-0" value=<?php echo "Rp" .
                                            $item["price"]; ?> readonly id="exampleSelect1">
                    ...
                    <div class="food-item white">
                        <div class="row">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn theme-btn">Tambahan</button>
                            </div>
                        </div>
                    </div>
                </div>
