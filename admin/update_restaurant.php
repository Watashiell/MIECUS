    ...
    if (empty($_POST['c_name']) || empty($_POST['res_name']) || $_POST['email'] == '' || $_POST['phone'] == '' || $_POST['url'] == '' || $_POST['o_hr'] == '' || $_POST['c_hr'] == '' || $_POST['o_days'] == '' || $_POST['deskripsi'] == '') {
        ...
        if ($extension == 'jpg' || $extension == 'png' || $extension == 'gif') {
            if ($fsize >= 1000000) {
                ...
                $sql = "update restaurant set c_id='$_POST[c_name]', title='$res_name',email='$_POST[email]',phone='$_POST[phone]',url='$_POST[url]',o_hr='$_POST[o_hr]',c_hr='$_POST[c_hr]',o_days='$_POST[o_days]',deskripsi='$_POST[deskripsi]',image='$fnew' where rs_id='$_GET[res_upd]' "; // store the submited data ino the database :images												mysqli_query($db, $sql); 
                mysqli_query($db, $sql);
...
<body class="fix-header">
    ...
    <div id="main-wrapper">
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                <div class="navbar-header">
                    <a class="navbar-brand" href="dashboard.php">
                        ...
                        <span><img src="images/banner.png" alt="homepage" class="dark-logo" /></span>
                    </a>
                </div>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="col-lg-12">
                    <div class="card card-outline-primary">
                        ...
                        <h4 class="m-b-0 ">Update Kategori</h4>
                            ...
                            <form action='' method='post' enctype="multipart/form-data">
                                <div class="form-body">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="phone" class="form-control"
                                                    value="<?php echo $row['phone']; ?>" placeholder="+62">
                                            </div>
                                        </div>

                                        <div class="col-md-6">
                                            <div class="form-group has-danger">
                                                <label class="control-label">Website Toko</label>
                                                <input type="text" name="url" class="form-control form-control-danger"
                                                    value="<?php echo $row['url']; ?>" placeholder="www.miesuh.com">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label">Jam Tersedia</label>
                                                <select name="o_hr" class="form-control custom-select"
                                                    data-placeholder="Choose a Category">
                                                    <option>--Jadwal Menu Tersedia--</option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label">Tutup Pesanan</label>
                                                <select name="c_hr" class="form-control custom-select"
                                                    data-placeholder="Choose a Category">
                                                    <option>--Jadwal Pesanan Tutup--</option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label">Jadwal Buka Toko</label>
                                                <select name="o_days" class="form-control custom-select"
                                                    data-placeholder="Choose a Category" tabindex="1">
                                                    <option>--Jadwal Buka--</option>
                                                    <option value="sen-sel">sen-sel</option>
                                                    <option value="sen-rab">sen-rab</option>
                                                    <option value="sen-kam">sen-kam</option>
                                                    <option value="sen-jum">sen-jum</option>
                                                    <option value="sen-sab">sen-sab</option>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="control-label">Pilih Tag</label>
            ...
            <footer class="footer"> © 2022 - Miesuh</footer>
        </div>
