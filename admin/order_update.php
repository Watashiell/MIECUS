...
if (strlen($_SESSION['user_id']) == 0) {
    ...
    if (isset($_POST['update'])) {
        ...
        $sql = mysqli_query($db, "update users_orders set remark='$remark' where o_id='$form_id'");
            ...
            <table border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    ...
                    <td><input type="submit" name="update" class="btn btn-primary" value="Submit">
                        ...
                        <input name="Submit2" type="submit" class="btn btn-danger" value="Cancel "
