                            ...
                            <form action='' method='post' enctype="multipart/form-data">
                                <div class="form-body">
                                    ...
                                    <div class="row p-t-20">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group has-danger">
                                                <label class="control-label">Email Toko </label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="o_hr" class="form-control custom-select"
                                                    ...
                                                    <option>--Pilih Jam Tersedia--</option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label">Pesanan Tutup</label>
                                                <select name="c_hr" class="form-control custom-select"
                                                    data-placeholder="Choose a Category">
                                                    <option>--Jam Tidak Menerima Pesanan--</option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label">Jadwal Toko</label>
