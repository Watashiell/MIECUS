    ...
    <div style=" background-image: url('images/img/bener.png');">
        ...
        if (isset($_POST['submit'])) {
            ...
            if (!empty($_POST["submit"])) {
                $loginquery = "SELECT * FROM users WHERE username='$username' && password='" . md5($password) . "'"; //memilih data yg sesuai
                $result = mysqli_query($db, $loginquery); //eksekusi
        ...
        <div class="pen-title">
            < </div>
                ...
                <div class="module form-module">
                    ...
                    <div class="cta">Belum Punya Akun?<a href="registration.php" style="color:#5c4ac7;"> Buat Akun</a>
                    </div>
                </div>
