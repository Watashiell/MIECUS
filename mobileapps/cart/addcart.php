...
include ("../koneksi.php");
    ...
    if ($con) {
    $sql = "SELECT * FROM `cart` WHERE `u_id` = '".$id_user."' AND `id_product`='".$id_product."' AND `note`='".$note."';";
    ...
    if (mysqli_num_rows($res) != 0) {
        ...
        $sqle = "
INSERT INTO `cart` (`id_cart`, `u_id`, `id_product`, `title_product`, `image`, `description`, `note`, `price`, `quantity`) VALUES (null,'".$id_user."','".$id_product."','".$title_product."','".$image."','".$description."','".$note."','".$price."','".$quantity."');";
